...
`https://matrix.to/#/#Hack.lu_2024-OpenSSH_Workshop:matrix.org`

Used to exchange links and commands.

Workshop repository:

**https://github.com/wllm-rbnt/hacklu-2024-openssh-workshop**

```bash
git clone https://github.com/wllm-rbnt/hacklu-2024-openssh-workshop.git
cd hacklu-2024-openssh-workshop
```

Shorter URLs:

- Matrix Room -> **https://t.ly/wjSQU**
- Repository -> **https://t.ly/QrHP4**
...
- Retrieve the server keys fingerprints through a secure channel:
    ...
    **https://github.com/wllm-rbnt/hacklu-2024-openssh-workshop/blob/main/fingerprints.txt**
...
**Note**: *internal* host key fingerprints available at **https://github.com/wllm-rbnt/hacklu-2024-openssh-workshop/blob/main/fingerprints.txt**
